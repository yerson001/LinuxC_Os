...
/*
            ...
            //=============history=================
            if(args[1]==NULL && strcmp(args[0],"history")==0) {// comparamos que la entrada sea "histori"
                    print_history();
                     //printf("historial detectado\n");
             continue;
            }
             char **argsPtr = history_computation(args, &EsperaPadreWait);
             //========================================================
*/
